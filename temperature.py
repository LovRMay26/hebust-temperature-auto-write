...
class AuotoWrite:
    ...
    def __init__(self):
        ...
        self.param = {
            "stuNum": "200704211",  # 学号
            "pwd": "Lc2#0201222435",  # 密码
            "vcode": "",
        }
        self.my_email = "2732875616@qq.com"  # 此处是python发送邮件利用的邮箱
        self.send_mail = "2732875616@qq.com"  # 此处是接收填写情况的邮箱
        self.license_code = "ojbrhocnmbpodfbg"  # 发送邮箱的pop授权码
